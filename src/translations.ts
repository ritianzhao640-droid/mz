export const translations = {
  en: {
    ...
    step1Desc: "Stake tokens to earn WBNB dividends. Note: Staking is equivalent to burning; you gain dividend weight but lose ownership of the staked tokens permanently.",
  ...
  zh: {
    ...
    step1Title: "质押或购票",
    step1Desc: "质押代币以赚取 WBNB 分红。注意：质押代币等于销毁代币，获得分红权重的同时也失去了已质押代币的所有权。",
    step2Title: "赚取 WBNB",
